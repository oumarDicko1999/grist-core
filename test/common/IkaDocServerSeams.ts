...
const SERVER_SEAMS = [
  ...
  },
  {
    ...
    anchors: [
      ...
      "sessionMatchesDocumentId",
      "assertIkaDocUserActionsAllowedForSession",
      "tableId === \"_grist_Cells\"",
      "return [\"canUseComments\"]",
    ],
  },
  {
    file: "app/server/lib/IkaDocActiveDocMethod.ts",
    anchors: [
      "ikaDocRuntimeSessionFromAuthSession",
